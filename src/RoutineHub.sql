...
--
-- Host: localhost    Database: RoutineHub
-- ------------------------------------------------------
...
INSERT INTO `goal` VALUES (1,'More family time','Family',0,1),(2,'More work time','Work',0,1),(3,'More hobby time','Hobby',0,2),(4,'More personal time','Personal',0,2);
...
INSERT INTO `habit` VALUES (1,'Pay Bills',NULL,2,4,50,100),(2,'Tidy up',NULL,3,4,0,25),(3,'Go to sleep before 10:30','So you can be in a good mood tomorrow :)',3,4,200,200),(4,'Meditate','Hmmmmmm',3,4,9000,9000),(5,'Draw',NULL,2,3,50,100),(6,'Call mom','+31684843940',2,1,0,0),(7,'Floss',NULL,3,4,25,100),(8,'Finish Homework',NULL,4,2,0,0),(9,'Go to sleep before 1:00','Because who in their healthy mind sleeps that late?',2,4,300,500),(10,'Exercise',NULL,4,4,40,100),(11,'Practice music instrument',NULL,4,3,0,400),(12,'Take nature pictures',NULL,3,3,0,0),(13,'Visit relatives',NULL,3,1,50,50);
...
CREATE TABLE `habit_day_of_week` (
  ...
  CONSTRAINT `habit_day_of_week_day_of_week` FOREIGN KEY (`day_of_week_id`) REFERENCES `day_of_week` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `habit_day_of_week_habit` FOREIGN KEY (`habit_id`) REFERENCES `habit` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-09 15:11:43
