...
var re = function(){
    ...
    var openBtn = document.getElementsByClassName("goalGraphBtn");
    var graph = document.getElementById("progressGraph");
    var closeBtn = document.getElementById("closeProgressGraph");
    ...
    closeBtn.onclick = function(){
        setTimeout(function(){graph.style.display = "none";}, 1100);
        graph.classList.remove("modalBox-here");
    }
...
var refreshHabits = function () {
    ...
    */
    ...
    var editHabit = (function () {
        ...
        saveEditHabitBtn.onclick = function () {
            var name = habitEditForm[0].value;
